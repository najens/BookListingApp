...
public class QueryUtils {
    ...
    /**
     * Query the Google Books dataset and return an {@link List<Book>} object to represent a
     * list of books.
     */
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                if (volumeInfo.has("categories")) {
                    subject = volumeInfo.getString("categories");
                ...
                Book book = new Book(title, author, subject, pages, url, image);
                books.add(book);
            }
